...
PIT are a good map for ROR. However, we could not map ABS to PIT operators.
...
The original statement deletion was proposed by Acree~\cite{acree1980onmutation}.
