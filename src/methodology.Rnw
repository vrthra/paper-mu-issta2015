...
For this criteria, we used the two operators \pitcb, and \pitnc which are similar to those given by Wong.
\subsubsection{Criteria II}
We used the operators given by Offutt et al. \pitin, \pitm, \pitcb, \pitnc.
...
By Namin et al. \pitin, \pitm, \piti, \pitnc.
