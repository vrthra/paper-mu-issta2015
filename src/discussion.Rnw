...
lines, with regard to the stability of the result (i.e low sd).
...
We did not see the pattern found by Zhang et al.~\cite{zhang2013ase} where by
the method based sampling had the highest accuracy. In fact, in our measurements,
