...
<<results='asis'>>=
print(tbl.place(xtable(s.singles.db, caption='Single Operators', label='table:singles')), include.rownames=T, floating=F, size='\\small',sanitize.text.function=function(x){x})
@
