...
o.stats.sel.op$operator  <- gsub('_','',gsub('op.*:','', o.stats.sel.op$operator))
r.stats.sel.op$operator  <- gsub('_','',gsub('op.*:','', r.stats.sel.op$operator))

o.stats.sel.op <- o.stats.sel.op[,c(0,6,1,2,3,4,5)]
r.stats.sel.op <- r.stats.sel.op[,c(0,6,1,2,3,4,5)]
...
o.stats.sel.opsel <- o.stats.sel.opsel[,c(0,6,1,2,3,4,5)]
r.stats.sel.opsel <- r.stats.sel.opsel[,c(0,6,1,2,3,4,5)]
