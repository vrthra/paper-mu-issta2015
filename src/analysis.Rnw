...
print(tbl.place(xtable(s.selective.db, caption='Selective Strategy', label='table:selective')),include.rownames=T, floating=F, size='\\small',sanitize.text.function=function(x){x})
@
...
%\caption*{N-Selection}
<<results='asis'>>=
print(tbl.place(xtable(s.nselection.db, caption='N-Selection', label='table:nselection')), include.rownames=T, floating=F, size='\\small',sanitize.text.function=function(x){x})
@
...
<<results='asis'>>=
print(tbl.place(xtable(s.opsample.db, caption='Operator x samples', label='table:opsample')), include.rownames=T, floating=F, size='\\small',sanitize.text.function=function(x){x})
@
\caption {The operator based fractional sample strategy}
\label{tbl:opsample}
\end{table*}
...
<<results='asis'>>=
print(tbl.place(xtable(s.lmcp.db, caption='Element Scoped', label='table:element')), include.rownames=T, floating=F, size='\\small',sanitize.text.function=function(x){x})
@
\caption {The element based fractional sample strategy}
\label{tbl:element}
\end{table*}
...
print(tbl.place(xtable(s.singles.db[norder,], caption='Single Operators', label='table:singles')), include.rownames=T, floating=F, size='\\small',sanitize.text.function=function(x){x})
@
...
Similarly \textit{baseline effectiveness} is computed by getting the number
