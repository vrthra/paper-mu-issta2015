...
o.x <- subset(o, select=c('operator', 'r.square', 'mutant.reduction', 'sample', 'score.multiplier'))
colnames(o.x) <- c('operator', 'r^2', 'm.red', 'sample', 'mcov.mult')
...
r.x <- subset(r, select=c('operator','r.square', 'mutant.reduction', 'sample', 'score.multiplier'))
colnames(r.x) <- c('operator', 'r^2', 'm.red', 'sample', 'mcov.mult')
