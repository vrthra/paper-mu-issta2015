...
hist(log(10,m$pit.mutation.total.sdl), breaks=50, col=rgb(0,0,1,1/4))
hist(log(10,m$pit.mutation.num.sdl), breaks=50, add=T, col=rgb(1,0,0,1/4))

hist(log(10,m$pit.mutation.total.rnd), breaks=50, col=rgb(0,0,1,1/4))
hist(log(10,m$pit.mutation.num.rnd), breaks=50, add=T, col=rgb(1,0,0,1/4))

hist(log(10,m$pit.mutation.total), breaks=50, col=rgb(0,0,1,1/4))
